...
@interface ChoseImageController ()
...
@implementation ChoseImageController
...
- (void)cancel:(id)sender {
    if (self.delegate && [self.delegate conformsToProtocol:@protocol(ChoseImageControllerDlegate)]) {
