...
{
    NSString *str =strResult.strScanned;//澳洋集团的二维码：
//    UIImage *image =strResult.imgScanned;
//    NSString *type =strResult.strBarCodeType;
    //NSLog(@"%@,%@",image,type);
    ScanResultViewController *vc = [[ScanResultViewController alloc]initWithUid:str];;
